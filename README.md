...
### **Employee**
- **Username:** `company@workzone.com`
- **Password:** `company123`

## 🔔 Discord Notifications

This project is integrated with **Discord Webhooks** to provide real-time updates.

Whenever a CI/CD workflow runs (build, test, or deployment), automatic notifications are sent to our Discord channel, keeping the team informed about the project status.

🔗 **Discord Channel:** https://discord.gg/eG5CQhAE
